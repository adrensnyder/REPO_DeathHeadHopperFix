...
{
    [HarmonyPatch]
    internal static class LastChanceMonstersSharedSearchModule
    {
        ...
        private static readonly MethodInfo? s_getAllProxyMethod =
            AccessTools.Method(typeof(LastChanceMonstersSharedSearchModule), nameof(GetAllPlayersWithinRangeLastChanceAware));

        private static readonly MethodInfo? s_getNearestProxyMethod =
            AccessTools.Method(typeof(LastChanceMonstersSharedSearchModule), nameof(GetNearestPlayerWithinRangeLastChanceAware));
